...
urlpatterns = [
    ...
    path(
        "shopkeeperlogin",
        LoginView.as_view(template_name="hospital/shopkeeperlogin.html"),
    ),
    ...
    path(
        "admin-view-shopkeeper",
        views.admin_view_shopkeeper_view,
        name="admin-view-shopkeeper",
    ),
    path(
        "delete-shopkeeper-from-hospital/<int:pk>",
        views.delete_shopkeeper_from_hospital_view,
        name="delete-shopkeeper-from-hospital",
    ),
    path(
        "update-shopkeeper/<int:pk>",
        views.update_shopkeeper_view,
        name="update-shopkeeper",
    ),
    path(
        "admin-add-shopkeeper",
        views.admin_add_shopkeeper_view,
        name="admin-add-shopkeeper",
    ),
    path(
        "admin-approve-shopkeeper",
        views.admin_approve_shopkeeper_view,
        name="admin-approve-shopkeeper",
    ),
    path(
        "approve-shopkeeper/<int:pk>",
        views.approve_shopkeeper_view,
        name="approve-shopkeeper",
    ),
    path(
        "reject-shopkeeper/<int:pk>",
        views.reject_shopkeeper_view,
        name="reject-shopkeeper",
    ),
    path(
        "admin-view-shopkeeper-type",
        views.admin_view_shopkeeper_type_view,
        name="admin-view-shopkeeper-type",
    ),
...
urlpatterns += [
    ...
    path(
        "patient-book-order", views.patient_book_order_view, name="patient-book-order"
    ),
    path(
        "patient-view-order", views.patient_view_order_view, name="patient-view-order"
    ),
    path(
        "patient-view-doctor",
...
urlpatterns += [
    path(
        ...
        views.shopkeeper_dashboard_view,
        name="shopkeeper-dashboard",
    ),
    path("search", views.search_view, name="search"),
    path(
        "shopkeeper-patient", views.shopkeeper_patient_view, name="shopkeeper-patient"
    ),
    path(
        "shopkeeper-view-patient",
        views.shopkeeper_view_patient_view,
        name="shopkeeper-view-patient",
    ),
    # path('shopkeeper-view-discharge-patient',views.shopkeeper_view_discharge_order_view,name='shopkeeper-view-discharge-order'),
    path(
        "shopkeeper-order", views.shopkeeper_order_view, name="shopkeeper-appointment"
    ),
    path(
        "shopkeeper-view-order",
        views.shopkeeper_view_order_view,
        name="shopkeeper-view-order",
    ),
    path(
        "shopkeeper-delete-order",
        views.shopkeeper_delete_order_view,
